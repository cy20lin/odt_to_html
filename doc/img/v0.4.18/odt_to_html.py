...
class ODTConverter:
    ...
    def _process_paragraph(self, para: ET.Element) -> str:
        ...
        # Split content into inline text and anchored objects
        inline_content, anchored_content_list = self._process_paragraph_content_split(para)
    ...
    def _process_paragraph_content_split(self, element: ET.Element) -> tuple[str, list[str]]:
        """Process paragraph content, separating inline content from paragraph-anchored objects."""
        inline_parts = []
        anchored_parts = []
        ...
        for child in element:
            ...
            # Determine if this is a paragraph-anchored object
            # We strictly separate objects with anchor-type="paragraph"
            is_anchored = (anchor_type == 'paragraph')
        ...
        return "".join(inline_parts), anchored_parts
    ...
    def _process_child_to_html(self, child: ET.Element) -> str:
        ...
        if (x and y) or has_transform_position or anchor_type in ('paragraph', 'char'):
            # Shapes with x/y coordinates, or transform with translate, or paragraph/char anchor
